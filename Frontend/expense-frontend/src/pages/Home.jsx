    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0b0617] via-[#120824] to-black text-white px-6 py-10">
      ...
      <section className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto text-center">
        <div className="bg-purple-900/20 backdrop-blur border border-purple-500/20 rounded-xl p-6 shadow-lg hover:shadow-purple-900/40 transition">
          <h3 className="text-xl font-bold text-purple-300">🚀 Instant Overview</h3>
          <p className="text-purple-200/70 mt-2">Dashboard shows total spent, balance left, and budget insights.</p>
        </div>
        <div className="bg-purple-900/20 backdrop-blur border border-purple-500/20 rounded-xl p-6 shadow-lg hover:shadow-purple-900/40 transition">
          <h3 className="text-xl font-bold text-purple-300">📈 Smart Visuals</h3>
          <p className="text-purple-200/70 mt-2">Pie charts, category-wise breakdowns & average transaction tracking.</p>
        </div>
        <div className="bg-purple-900/20 backdrop-blur border border-purple-500/20 rounded-xl p-6 shadow-lg hover:shadow-purple-900/40 transition">
          <h3 className="text-xl font-bold text-purple-300">🛠 Easy Management</h3>
          <p className="text-purple-200/70 mt-2">Add, edit, or delete your income and expenses anytime.</p>
        </div>
      </section>
      ...
      {/* Footer */}
      <footer className="mt-24 text-center text-purple-200/50 text-sm">
